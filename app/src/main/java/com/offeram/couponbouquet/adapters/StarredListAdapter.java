...
public class StarredListAdapter extends RecyclerView.Adapter<StarredListAdapter.MyViewHolder> {
    private LayoutInflater inflater;
    private Context context;
    List<SearchItem> data = new ArrayList<>();


    public StarredListAdapter(Context context, List<SearchItem> data) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.row_starred_list, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.couponTv.setText(si.getCouponTitle());
        holder.categoryNameTv.setText(si.getCategoryName());
        holder.numOfOffersTv.setText(si.getNumOfOffers() + " Offers");
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView numOfOffersTv, distanceTv, titleTv, reviewTv, outletTv, couponTv, categoryNameTv, redeemTv;

        public MyViewHolder(View itemView) {
            super(itemView);
            imageIv = (ImageView) itemView.findViewById(R.id.imageIv);
            starredIv = (ImageView) itemView.findViewById(R.id.starredIv);
            numOfOffersTv = (TextView) itemView.findViewById(R.id.numOfOffersTv);
