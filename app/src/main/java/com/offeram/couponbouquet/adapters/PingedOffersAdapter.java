...
public class PingedOffersAdapter extends RecyclerView.Adapter<PingedOffersAdapter.MyViewHolder> {
    ...
    public PingedOffersAdapter(Context context, List<Merchant> data, String geallFavourite) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("message", "You have already pinged this coupon erlier.");
        ...
        holder.txt_accept.setText("Accepted");
        ...
        if (Config.isConnectedToInternet(context)) {
            ...
            call.enqueue(new Callback<GetAllFavorites>() {
                ...
                public void onResponse(Call<GetAllFavorites> call, Response<GetAllFavorites> response) {
                    ...
                    if (gf.getSuccess() == 1) {
                        Intent intent = new Intent(context, PingedOffers.class);
                        context.startActivity(intent);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.fromNameTv.setText(si.getFrom_user_name());

        if (si.getCoupons().get(0).getPing_status().equals("1")) {
            holder.acceptLayout.setVisibility(View.VISIBLE);
            holder.txt_accept.setText("Accepted");
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView distanceTv, titleTv, reviewTv, outletTv, couponTv, fromNameTv, statusTv,toTv,txt_accept;
